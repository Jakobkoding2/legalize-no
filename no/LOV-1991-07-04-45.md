...
subjects: ["Ekteskap og samboerskap (husstandsfellesskap)", "Skifte"]
misc: "Jf. lov 4 juli 1991 nr. 47 § 95 ."
---
...
Dersom et av husstandsmedlemmene dør, kan gjenlevende, når særlige grunner taler for det, i forhold til avdødes arvinger få følgende rettigheter til husstandsmedlemmenes felles hjem: rett til å løse inn andel, aksje eller obligasjon som tilhørte den avdøde, og som retten til felles bolig er knyttet til, eller rett til å overta boligeiendom eller til å tre inn i andel av boligeiendom som tilhørte den avdøde og som utelukkende eller hovedsakelig har tjent til felles bolig, og rett til å overta eller tre inn i andel av vanlig innbo.
